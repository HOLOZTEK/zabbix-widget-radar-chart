...
use Modules\RadarChart\Includes\CWidgetFieldItemsView;
...
(new CWidgetFormView($data))
	...
	->addItem([
		...
		new CFormField(
			(new CDiv([
				...
				(new CDiv([
					(new CTag('span', true, _rc('Title')))->addClass('rc-style-label'),
	...
	->addJavaScript('widget_radar_chart_form.init();')
	->show();
